...
#define STRING_CONFIG_H_AUTHOR "(Gerard Alquezar Artieda, Sunhokey Prusa i4 config)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Sunhokey i4"
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80.4, 80.4, 404, 90 }
